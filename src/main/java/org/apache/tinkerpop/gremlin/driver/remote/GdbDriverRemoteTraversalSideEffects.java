...
import org.apache.tinkerpop.gremlin.driver.GdbHost;
...
public class GdbDriverRemoteTraversalSideEffects extends AbstractRemoteTraversalSideEffects {
     ...
     */
    @Deprecated
    public GdbDriverRemoteTraversalSideEffects(final GdbClient client, final UUID serverSideEffect, final GdbHost host,
    ...
    public GdbDriverRemoteTraversalSideEffects(final GdbClient client, final GdbResultSet rs) {
        this.client = client;
