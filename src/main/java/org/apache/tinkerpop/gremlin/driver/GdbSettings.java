...
final public class GdbSettings {
    ...
    public static GdbSettings read(final InputStream stream) {
        ...
        final Constructor constructor = new Constructor(GdbSettings.class);
        final TypeDescription settingsDescription = new TypeDescription(GdbSettings.class);
        ...
        return yaml.loadAs(stream, GdbSettings.class);
    }
    ...
    static class ConnectionPoolSettings {
        ...
        /**
         * The minimum size of a connection pool for a {@link GdbHost}. By default this is set to 2.
         */
        public int minSize = GdbConnectionPool.MIN_POOL_SIZE;

        /**
         * The maximum size of a connection pool for a {@link GdbHost}. By default this is set to 8.
         */
        public int maxSize = GdbConnectionPool.MAX_POOL_SIZE;
         ...
         */
        public long keepAliveInterval = GdbConnection.KEEP_ALIVE_INTERVAL;
         ...
         */
        public int minSimultaneousUsagePerConnection = GdbConnectionPool.MIN_SIMULTANEOUS_USAGE_PER_CONNECTION;
         ...
         */
        public int maxSimultaneousUsagePerConnection = GdbConnectionPool.MAX_SIMULTANEOUS_USAGE_PER_CONNECTION;

        /**
         * The maximum number of requests in flight on a connection where the default is 4.
         */
        public int maxInProcessPerConnection = GdbConnection.MAX_IN_PROCESS;
         ...
         */
        public int minInProcessPerConnection = GdbConnection.MIN_IN_PROCESS;

        /**
         * The amount of time in milliseconds to wait for a new connection before timing out where the default value
         * is 3000.
         */
        public int maxWaitForConnection = GdbConnection.MAX_WAIT_FOR_CONNECTION;
         ...
         */
        public int maxWaitForSessionClose = GdbConnection.MAX_WAIT_FOR_SESSION_CLOSE;
         ...
         */
        public int maxContentLength = GdbConnection.MAX_CONTENT_LENGTH;

        /**
         * The amount of time in milliseconds to wait before trying to reconnect to a dead host. The default value is
         * 1000.
         */
        public int reconnectInterval = GdbConnection.RECONNECT_INTERVAL;

        /**
         * The override value for the size of the result batches to be returned from the server. This value is set to
         * 64 by default.
         */
        public int resultIterationBatchSize = GdbConnection.RESULT_ITERATION_BATCH_SIZE;

        /**
         * The constructor for the channel that connects to the server. This value should be the fully qualified
         * class name of a Gremlin Driver {@link GdbChannelizer} implementation.  By default this value is set to
         * {@link GdbChannelizer.WebSocketChannelizer}.
         */
        public String channelizer = GdbChannelizer.WebSocketChannelizer.class.getName();
