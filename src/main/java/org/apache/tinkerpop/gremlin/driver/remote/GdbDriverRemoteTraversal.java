...
public class GdbDriverRemoteTraversal<S, E> extends AbstractRemoteTraversal<S, E> {
    ...
    public GdbDriverRemoteTraversal(final GdbResultSet rs, final GdbClient client, final boolean attach, final Optional<Configuration> conf) {
        ...
        this.sideEffects = new GdbDriverRemoteTraversalSideEffects(client, rs);
    }

    /**
     * Gets a side-effect from the server. Do not call this method prior to completing the iteration of the
     * {@link GdbDriverRemoteTraversal} that spawned this as the side-effect will not be ready. Generally
